def Comprehensions_and_Lamda():
    ...
    nlt = [x for x in range(10)]
    print(nlt)   #prints-> numbers from 0 to 9
    
    lit = [x for x in range(10) if x<5]
    print(lit)
    
    nst = [x.upper() for x in fruits] 
    print(nst)
    
    newt = ["hello" for x in fruits]
    print(newt)          #Where there was a item in fruits ,it prints "hello"
    
    nlst = [x if x != "banana" else "orange" for x in fruits]
    print(nlst)        #if-else inside a for-loop 
